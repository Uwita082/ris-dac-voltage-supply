...
from domain.dac_2688_channel import QueueChannelUpdate, ChannelSettingValue, ChannelWriteValue, ChannelValue
from protocol.protocol_service import Protocol
...
class DAC2688:
    ...
    def write_values_dac(self) -> None:
        list_instructions: bytearray | None = self._retrieve_write_commands()
