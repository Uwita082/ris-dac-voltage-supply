...
int main() {
    ...
    std::vector<uint8_t> cmd1 = {0x40, 0xFF, 0xF0, 0x00, 0x40, 0xFF, 0xF0, 0x00, 0x40, 0xFF, 0xF0, 0x00, 0x40, 0xFF, 0xF0, 0x00}; //Channel index 2 <> -15 V
    std::vector<uint8_t> cmd2 = {0x40, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00}; //Channel index 2 <> +15 V
